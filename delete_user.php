...
if ( (isset($_GET['id'])) && (is_numeric
	...
	$id = $_GET['id'];
		...
		(is_numeric($_POST['id'])) ) { // For submission.
	$id = $_POST['id'];
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
	...
	if ($_POST['sure'] == 'Yes') {
		...
		// Make the query:
		$q = "DELETE FROM patient WHERE
		Patient_id=$id LIMIT 1";
	...
	$q = "SELECT CONCAT(LastName, ',
	', FirstName) FROM patient WHERE
	Patient_id=$id";
	$r = @mysqli_query ($dbc, $q);
